            ...
            <div class="card">
                <div class="card-body">
                    <div class="justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800 mb-4 ">Tambah Pelukis</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 my-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_pelukis" class="form-control mt-2" value="{{ old('nama_pelukis') }}" placeholder="Masukan nama pelukis">
                            ...
                            <div class="col-lg-12 my-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_telepon" class="form-control mt-2" value="{{ old('nomor_telepon') }}" placeholder="Masukan nomor telepon pelukis">
                                    @error('nomor_telepon')
